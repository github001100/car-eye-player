...
import org.Careye.CarEyePlayer.data.VideoSource;
...
import org.Careye.rtsp.player.databinding.VideoSourceItemBinding;
...
//        setContentView(R.layout.content_playlist);
        ...
        mRecyclerView = mBinding.recycler;////1
        ...
        mRecyclerView.setAdapter(new RecyclerView.Adapter() {
            ...
            public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
                ...
                //String url2 = mBinding.txtInputUrl.getText().toString() ;
        ...
        if (!isPro()) {
            ...
            /*mBinding.btnPlayVideo.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    //startActivity(new Intent(PlaylistActivity.this, SettingsActivity.class));
                    Toast toast = Toast.makeText(getApplicationContext(), mBinding.txtInputUrl.getText(), Toast.LENGTH_LONG);
                    toast.show();
                    //mBinding.showVideo.setVideoPath(mBinding.txtInputUrl.getText().toString());
                    //mBinding.showVideo.start();
                }
            });*/
...
//        });
        ...
        if (PlaylistActivity.isPro()) {
            url = "http://www.car-eye.cn/versions/easyplayer_pro/version.txt";
        } else {
            ...
            protected Cursor doInBackground(Void... voids) {
                try {
                    ...
                    if (response.isSuccessful()) {
                        ...
                        JSONArray array = json.getJSONObject("car-eye").getJSONObject("Body").getJSONArray("Sessions");
