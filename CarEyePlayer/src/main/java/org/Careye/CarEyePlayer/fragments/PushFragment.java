...
import static org.Careye.CarEyePlayer.fragments.PlayFragment.ARG_PARAM3;
...
public class PushFragment extends Fragment implements TextureView.SurfaceTextureListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        btn_url = getActivity().findViewById(R.id.btn_push_url);
        btn_push = getActivity().findViewById(R.id.btn_push_stop);//内 推流按钮
...
//        args.putInt(ARG_PARAM2, type);
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surface, int width, int height) {
        ...
        final String serialno = pref.getString(getString(R.string.key_shebei), "123456");
            ...
            public void onClick(View v) {
               ...
               // btn_url.setText(key_url);
                if (flag == 0 && mUpload == true) {
                    ...
                    btn_push.setText("停止");
                    mChannel = StartVideoUpload(sip, key_port, serialno);
                    mUpload = true;
                    flag = 0;
                    btn_url.setVisibility(View.VISIBLE);
                    btn_url.setText("rtsp://" + sip + ":" + key_port + "/" + serialno + "&channel=1.sdp".toLowerCase());
                }
                if (mUpload == false) {
                } else {
                }
