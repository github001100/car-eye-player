...
import org.Careye.CarEyePlayer.PlayActivity;
import org.Careye.CarEyePlayer.TheApp;
import org.Careye.CarEyePlayer.views.AngleView;
import org.Careye.video.Client;
import org.Careye.video.CarEyePlayerClient;
import org.Careye.CarEyePlayer.PlaylistActivity;
...
public class PlayFragment extends Fragment implements TextureView.SurfaceTextureListener {
    ...
    /* 本Key为3个月临时授权License，如需商业使用或者更改applicationId，请邮件至support@car-eye.cn申请此产品的授权。
     */
    public static final String KEY = "6A59754D6A3469576B5A73414D433158714E4C4F6B76464659584E3555477868655756794C6D56345A536C58444661672F704C67523246326157346D516D466962334E68514449774D545A4659584E355247467964326C75564756686257566863336B3D";
//    public static final String KEY = "59617A414C5A36526D3432416855566170627035792B4676636D63755A57467A65575268636E64706269356C59584E3563477868655756794C6E4A3062584170567778576F50394C34456468646D6C754A6B4A68596D397A595541794D4445325257467A65555268636E6470626C526C5957316C59584E35";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            ...
            //mUrl = "rtsp://184.72.239.149/vod/mp4://BigBuckBunny_175k.mov";//rtsp://120.76.235.109:10554/careye_pusher2.sdp
