...
public class CarEyeMuxer {

    public static final boolean VERBOSE = true;
    private static final String TAG = CarEyeMuxer.class.getSimpleName();
    ...
    public CarEyeMuxer(String path, boolean hasAudio, long durationMillis) {
