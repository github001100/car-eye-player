...
import org.Careye.video.CarEyeMuxer;
 ...
 */
public class CarEyeAACMuxer extends CarEyeMuxer {
    MediaCodec mMediaCodec;
    String TAG = "CarEyeAACMuxer";
    ...
    public CarEyeAACMuxer(String path, boolean hasAudio, long durationMillis) {
