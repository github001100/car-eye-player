...
public class CarEyePlayer {

    private static final java.lang.String LOG_TAG = "CarEyePlayer";
    private final int mTransport;
    private final String mPath;
    private final String mKey;
    private Surface surface;
    private CarEyePlayerClient mRTSPClient;
    ...
    public static class EasyPlayerFactory{
        ...
        public CarEyePlayer build(){
            ...
            return new CarEyePlayer(mKey, mURI.getPath(), mTransportMode);
        }
    ...
    private CarEyePlayer(String key, String path, @EasyPlayerFactory.TRANSPORT_MODE int transport){
        mKey = key;
        mPath = path;
